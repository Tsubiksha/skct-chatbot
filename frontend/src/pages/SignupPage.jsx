...
export default function SignupPage() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#030712] text-white flex items-center justify-center font-sans overflow-hidden px-4">
      ...
      <div className="absolute top-[-20%] right-[-20%] w-[60vw] h-[60vw] bg-emerald-500/10 rounded-full blur-[180px] pointer-events-none" />
      <div className="absolute bottom-[-20%] left-[-20%] w-[60vw] h-[60vw] bg-blue-500/10 rounded-full blur-[180px] pointer-events-none" />
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 text-sm text-center">
            Create an account to save chat histories and explore nodes
          </p>
        </div>
